        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="ftco-nav">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item {{ request()->is('car') ? 'active' : '' }}"><a href="{{ route('cars') }}" class="nav-link">Cars</a></li>
     ...
     <section class="ftco-section ftco-no-pt bg-light">
    	<div class="container">
    		<div class="row no-gutters">
                ...
                <form method="POST" action="{{ route('request.store') }}" class="request-form ftco-animate bg-primary">
                  @csrf
